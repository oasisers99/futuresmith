...
class FrontController extends Controller
{
    ...
    public function main(Request $request){
        ...
        $projects = DB::select("SELECT trp.id,trp.title,trp.description,trp.member_no,trp.topic,trp.location,trp.country,trp.created_by,trp.tribe_id,trp.updated_at,trp.created_at
                              FROM tribe_project trp
                              ORDER BY rand() LIMIT 10");
        ...
        return view('pages.front.front', ['tribes' => $tribes, 'projects' => $projects, 'msgCount'=>$msgCount]);
    }
